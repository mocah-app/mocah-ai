      ...
      <div className="flex-1 overflow-hidden">
        <div className="h-full grid lg:grid-cols-2 gap-0">
          ...
          <div className="overflow-y-auto bg-background">
            <div className="max-w-xl mx-auto bg-card pt-0 shadow-2xl h-full">
              <div className="space-y-2 border flex items-center justify-center p-2 px-6 mb-4 mx-auto w-fit rounded-b-2xl bg-muted/10">
